  ...
  return (
    <section className="relative w-full px-6 md:px-12 pt-0 pb-12 md:pt-0 md:pb-24 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 min-h-[calc(100vh-100px)] mt-0 md:-mt-24 z-10">
      ...
      <div className="flex-1 relative w-full flex justify-center items-center mt-12 md:mt-0">
        ...
        <div className="relative w-full max-w-md lg:max-w-xl flex justify-center items-center animate-float">
          <img src={heroImg} alt="Students learning" className="w-full h-auto object-cover rounded-3xl shadow-[0_20px_50px_rgba(8,112,184,0.2)] relative z-10 transform transition-all duration-500 hover:scale-105 hover:-translate-y-2 hover:shadow-[0_30px_60px_rgba(8,112,184,0.4)]" />
        </div>
      </div>
    </section>
  );
